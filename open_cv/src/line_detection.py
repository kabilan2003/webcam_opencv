...
class LineDetector:
    def __init__(self):
        ...
        self.image_sub_rpi = rospy.Subscriber("/cv_camera/image_raw/compressed", CompressedImage, self.image_callback_compressed)
        self.image_sub = rospy.Subscriber(" /cv_camera/image_raw", Image, self.image_callback_raw)
